...
float cover_roundf(float x)
{
	return roundf(x);
}

long int cover_lroundf(float x)
{
	return lroundf(x);
}

long long cover_llroundf(float x)
{
	return llroundf(x);
}

long int cover_lround(double x)
{
	return lround(x);
}
...
int64_t cover_llabs(int64_t x)
{
	return llabs(x);
}

float cover_cbrtf(float x)
{
	return cbrtf(x);
}

int cover_isnan(double x)
{
	return isnan(x);
}
